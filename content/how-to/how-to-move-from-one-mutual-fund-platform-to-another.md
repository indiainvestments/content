---
title: "How to move from one mutual fund platform to another"
...
Please follow the steps mentioned in [here ](how-to-transfer-shares-from-one-demat-account-to-another)since transferring of Mutual fund in demat form is done in the same way.
...
> [!NOTE]
> If you want to convert your existing mutual fund from regular to direct, refer [here](how-to-switch-the-mutual-fund-from-regular-to-direct-plan)
